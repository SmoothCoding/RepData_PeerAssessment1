...
In the following I determine the interval the maximum number of steps:
...
We can see that activity is more distributed in a homogenous way on the weekend case. Here, the person is more active over the whole day.
